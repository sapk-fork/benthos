...
func init() {
	err := bundle.AllProcessors.Add(processors.WrapConstructor(func(c input.Config, nm bundle.NewManagement) (input.Streamed, error) {
...
services. You can find out more [in this document](/docs/guides/cloud/gcp).`,
		Config: docs.FieldComponent().WithChildren(
			...
			docs.FieldString("file", "An file path to be consumed."),
			codec.ReaderDocs,
			docs.FieldBool("action", "What to do").Advanced(),
